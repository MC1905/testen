...
test('should return error for invalid fixedRatePeriod', () => {
  ...
  expect(result).toBe('Ongeldige rentevaste periode gekozen.', `Expected error message "Ongeldige rentevaste periode gekozen." for invalid fixedRatePeriod, but received "${result}"`);
});
